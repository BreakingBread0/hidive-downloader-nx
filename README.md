...
* `-s <i> -e <s>` sets the show id and episode ids (comma-separated), episode ids can be "all" to download all episodes
...
* `node hidive -s 337 -e all` download all episodes from show with id 337
...
* Figure out why subtitles (JAP-HV, haven't tested on others) are too early for about 0.3-0.5 seconds